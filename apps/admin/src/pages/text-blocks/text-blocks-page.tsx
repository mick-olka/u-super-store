...
import { textBlocksFilter, text_blocks_columns } from "./data";

import MDEditor from "@uiw/react-md-editor";
import { useNavigate } from "react-router-dom";
import { ContentDialog, ItemsPage, TextBlockForm } from "src/components";
import { useTextBlockById, useTextBlocks, useUpdateTextBlock } from "src/hooks";
import type { I_TextBlock, I_TextBlockForm } from "src/models";
...
export const TextBlocksPage = () => {
	...
	const { text_block, isLoading: textBlockLoading } = useTextBlockById(
		tbId || undefined,
	);
