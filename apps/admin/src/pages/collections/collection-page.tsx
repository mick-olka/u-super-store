...
import type { I_CollectionForm, I_ProductPopulated } from "src/models";
...
export const CollectionPage = () => {
	...
	const handleAddItems = (ids: string[]) => {
		if (collection)
			updateItems({ id: collection._id, data: { action: "add", items: ids } });
	};
	...
	return (
		<>
			...
			>
				...
				<Button onClick={() => setProductsSelectionMode(true)}>
					Додати товари
				</Button>
			</ItemsPage>
