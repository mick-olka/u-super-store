import type { I_Collection } from "@/shared/models/collections-model";

import type { E_Locales, LocalesObjectT } from "./locales-model";
import type { I_PhotosBlock } from "./photos-model";
