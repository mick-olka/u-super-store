...
import { E_AppRoutes, type I_Order, type PageProps } from "@/shared/models";
import Link from "next/link";
import { useEffect, useState } from "react";

import { localeUrl } from "@/shared/utils";

export default function MyOrdersPage({ params }: PageProps<object>) {
							...
							<tr key={`item${item._id}`}>
								...
								<td className="p-2">
									<div className="flex justify-center">
										...
										>
											<button className="w-10 h-10 relative" type="button">
												<SearchIcon />
											</button>
										</Link>
									</div>
