...
export const TextField = forwardRef(
	(
		{ variant, inputSize, className, error, ...props }: Props,
			...
			<>
				<input
					...
					className={classnames(
						fieldVariants({ variant, inputSize, className }),
						"",
					)}
...
const fieldVariants = cva(
	"h-10 p-1 px-4 rounded-lg focus:outline-none focus:shadow-inner leading-none transition",
	{
		variants: {
			variant: {
				solid: "bg-gray-100",
